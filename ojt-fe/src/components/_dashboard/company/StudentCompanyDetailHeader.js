...
const StudentCompanyDetailHeader = (props) => {
    // const navigate = useNavigate();
    const { user } = props;

    // console.log(user);
    // const toComponentB = () => {
    //     navigate(`/admin/dashboard/company/update/${user.id}`, {
    //         state: {
    //             name: user.name,
...
StudentCompanyDetailHeader.propTypes = {
    user: PropTypes.object,
};

export default StudentCompanyDetailHeader;
